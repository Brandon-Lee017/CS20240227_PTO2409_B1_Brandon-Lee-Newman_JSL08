...
// Create instances with branch info for both branches A & B
const branchA = new BankBranch({ name: "Nedbank", location: "Somerset" });
const branchB = new BankBranch({ name: "Capitec", location: "Zevenwacht" });
